...
var PostHogFeatureFlags = /** @class */ (function () {
    ...
    PostHogFeatureFlags.prototype._getValidEvaluationEnvironments = function () {
        ...
        var envs = (_a = this._instance.config.evaluation_contexts) !== null && _a !== void 0 ? _a : this._instance.config.evaluation_environments;
        // Log deprecation warning if using old field (only once)
        if (this._instance.config.evaluation_environments &&
    ...
    PostHogFeatureFlags.prototype._callFlagsEndpoint = function (options) {
        ...
        var deviceId = this._instance.get_property('$device_id');
        var data = {
            token: token,
        ...
        var queryParams = this._instance.config.advanced_only_evaluate_survey_feature_flags
            ...
            : '';
        var url = this._instance.requestRouter.endpointFor('flags', flagsRoute + queryParams);
