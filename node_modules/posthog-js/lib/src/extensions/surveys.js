...
var SurveyManager = /** @class */ (function () {
    function SurveyManager(posthog) {
        ...
        this.handlePopoverSurvey = function (surveyParam, options) {
            ...
            var survey = (options === null || options === void 0 ? void 0 : options.position) || (options === null || options === void 0 ? void 0 : options.selector)
                ? __assign(__assign({}, surveyParam), { appearance: __assign(__assign(__assign({}, surveyParam.appearance), (options.position && { position: options.position })), (options.selector && { widgetSelector: options.selector })) }) : surveyParam;
            _this._clearSurveyTimeout(survey.id);
            var _f = options !== null && options !== void 0 ? options : {}, properties = _f.properties, initialResponses = _f.initialResponses;
            var hasPrefillData = initialResponses && Object.keys(initialResponses).length > 0;
            var isSurveyCompleted = hasPrefillData
                ? _this._handleInitialResponses(survey, initialResponses, properties)
                : false;
            ...
            if (delaySeconds <= 0) {
                return (0, preact_2.render)((0, jsx_runtime_1.jsx)(SurveyPopup, { posthog: _this._posthog, survey: survey, removeSurveyFromFocus: _this._removeSurveyFromFocus, properties: properties, style: positionStyle, isSurveyCompleted: isSurveyCompleted }), shadow);
            }
            var timeoutId = setTimeout(function () {
                ...
                (0, preact_2.render)((0, jsx_runtime_1.jsx)(SurveyPopup, { posthog: _this._posthog, survey: __assign(__assign({}, survey), { appearance: __assign(__assign({}, survey.appearance), { surveyPopupDelaySeconds: 0 }) }), removeSurveyFromFocus: _this._removeSurveyFromFocus, properties: properties, style: positionStyle, isSurveyCompleted: isSurveyCompleted }), shadow);
            }, delaySeconds * 1000);
    ...
    SurveyManager.prototype._handleUrlPrefill = function (survey) {
        ...
        var result = this._processPrefillData(survey, params);
        if (!result) {
            return;
        }
     ...
     */
    SurveyManager.prototype._handleInitialResponses = function (survey, initialResponses, properties) {
        var e_2, _a;
        var prefillParams = {};
        try {
        ...
        var result = this._processPrefillData(survey, prefillParams);
        if (!result) {
            return false;
        }
    ...
    SurveyManager.prototype._processPrefillData = function (survey, prefillParams) {
        try {
