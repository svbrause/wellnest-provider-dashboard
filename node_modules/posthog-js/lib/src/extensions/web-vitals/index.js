...
var WebVitalsAutocapture = /** @class */ (function () {
    ...
    Object.defineProperty(WebVitalsAutocapture.prototype, "useAttribution", {
        get: function () {
            var clientConfig = (0, core_1.isObject)(this._instance.config.capture_performance)
                ...
                : undefined;
            return clientConfig !== null && clientConfig !== void 0 ? clientConfig : true;
        },
        enumerable: false,
        configurable: true
    });
    ...
    WebVitalsAutocapture.prototype._loadScript = function (cb) {
        ...
        (_c = (_b = globals_1.assignableWindow.__PosthogExtensions__) === null || _b === void 0 ? void 0 : _b.loadExternalDependency) === null || _c === void 0 ? void 0 : _c.call(_b, this._instance, 'web-vitals', function (err) {
            ...
            var loadWebVitalsCallbacks = (_a = globals_1.assignableWindow.__PosthogExtensions__) === null || _a === void 0 ? void 0 : _a.loadWebVitalsCallbacks;
            if (loadWebVitalsCallbacks) {
                loadWebVitalsCallbacks(_this.useAttribution);
                cb();
            }
            else {
                cb();
