...
export type { FeatureFlagsCallback, FeatureFlagDetail, FeatureFlagMetadata, EvaluationReason, RemoteConfigFeatureFlagCallback, EarlyAccessFeature, EarlyAccessFeatureStage, EarlyAccessFeatureCallback, EarlyAccessFeatureResponse, } from '@posthog/types';
...
import type { SessionRecordingCanvasOptions, PerformanceCaptureConfig, InitiatorType, JsonType, Properties, EventName, CapturedNetworkRequest, SessionRecordingOptions, FeatureFlagDetail, ToolbarParams, PostHogConfig as BasePostHogConfig, PostHog as BasePostHogInterface } from '@posthog/types';
